...
public class LIve_wall extends AppCompatActivity {


    public static final String TAG = LIve_wall.class.getSimpleName();
    ...
    public static final String  URL_LIVE_GIF =
            "https://picasaweb.google.com/data/feed/api/user/116771515069011613362/albumid/6258945324786264017?alt=json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableString s = new SpannableString("Live Wallpapers");
        ...
        coordinatorLayout = (CoordinatorLayout) findViewById(R.id.container_body);
        ...
        pref = new PrefManager(LIve_wall.this);

        String url = URL_LIVE_GIF;
        Log.d(TAG, "Albums request url: " + url);

        utils = new Utils(LIve_wall.this);
...
/*        AppController.getInstance().getRequestQueue().getCache().remove(url);
        ...
        InitilizeGridLayout();
        Ladapter = new gifrecycler_adapter(LIve_wall.this,photosList,columnWidth,columnWidth);
        ...
        gridView.addOnItemTouchListener(new RecyclerTouchListener(getBaseContext(), gridView, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent i = new Intent(LIve_wall.this,Gif_Image_activity.class);
    ...
    private void parseJsonFeed(JSONObject jsonObject) {
        try {
            JSONArray entry = jsonObject.getJSONObject(TAG_FEED).getJSONArray(TAG_ENTRY);
            ...
            e.printStackTrace();
            Toast.makeText(LIve_wall.this, getString(R.string.msg_unknown_error), Toast.LENGTH_LONG).show();
        }
